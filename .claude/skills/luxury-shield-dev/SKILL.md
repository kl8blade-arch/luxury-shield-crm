...
description: Development skill for Luxury Shield Insurance CRM. Use this skill whenever working on the Luxury Shield CRM, Sophia AI agent, WhatsApp webhook, Supabase database, Vercel deployment, pipeline, calendar, coaching system, training data, or any feature of this insurance CRM project. Also use when the user mentions Sophia, leads, agents, dental insurance, Cigna DVH Plus, WhatsApp integration, or any CRM functionality. This skill contains all project context, credentials, deployment commands, database schemas, and critical code patterns needed to work on this project without asking for information that's already documented here.
---
