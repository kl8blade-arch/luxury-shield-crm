  ...
  try {
    ...
    const { data: lead, error: leadError } = await supabase
      ...
      .insert({
        ...
        quiz_dentist_last_visit: body.quiz_dentist_last_visit || null,
        quiz_coverage_type: body.quiz_coverage_type || null,
        quiz_has_insurance: body.quiz_has_insurance || null,
        insurance_type: insuranceType,
