...
const PLANS = [
  {
    key: 'starter', name: 'Starter', price: 67, monthly: 67,
    ...
    features: [
      ...
      { text: 'Sub-cuentas', included: false },
      { text: 'Social Intelligence', included: false },
    ],
    leads: 100, agents: 1, cta: 'Empezar',
  },
  {
    key: 'professional', name: 'Professional', price: 197, monthly: 197,
    tagline: 'Para agentes serios',
    color: '#a78bfa', textColor: '#c4b5fd',
    features: [
    ...
    leads: 500, agents: 5, cta: 'Seleccionar',
  },
  {
    key: 'agency', name: 'Agency', price: 297, monthly: 297,
    ...
    features: [
      ...
      { text: 'Sub-cuentas (25)', included: true },
    ...
    leads: null, agents: 25, cta: 'Obtener Agency',
    savings: 'Solo $100 mas que Professional — 3x mas valor',
  },
  {
    ...
    features: [
      ...
      { text: '50+ sub-cuentas', included: true },
    ...
    leads: null, agents: 100, cta: 'Hablar con ventas',
  },
]
